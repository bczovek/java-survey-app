...
import com.bczovek.survey.csv.mapper.ParticipationMapper;
...
public class CsvLoader {
    ...
    public void init() {
        ...
        participations = participationMapper.mapMembersAndSurveys(participationParser.parse(), members, surveys);
    }
}
